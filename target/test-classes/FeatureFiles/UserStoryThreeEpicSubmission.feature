...
#    Then User inputs the remarks <remarks> and click on Save button
    Examples:
      |SectorName|grantoption|overseasoption|questionone|questiontwo|questionthree|question4|question5|Name|JobTitle|ContactNo|EmailAdress|AlternateEmailAdress|Postal|BlockNo|StreetDetails|SName|SJobTitle|SEmail|Title|ProjectTitle|StartDate|EndDate|ProDesc|Activity|TargetMarket|ExpansionOption|
      |IT|1|1|Yes|Yes|Yes|Yes|Yes|TestUser01|Consultant|91834399|test001@gmail.com|test002@gmail.com|520408|408|TAMPINES STREET 41|User02|Consultant|test012@gmail.com|SUBMIT YOUR PROPOSAL|TestTitle|28 Aug 2020|21 Dec 2020|Test Desc|                                                                  |            |Yes|